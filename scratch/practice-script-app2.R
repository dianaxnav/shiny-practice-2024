#this scatterplot shows length and weight of fish----
...
#different plot below that shows the distribution of the flipper length in between species 
...
ggplot(na.omit(island_df), aes(x = flipper_length_mm, fill = species)) +
  ...
  scale_fill_manual(values = c("Adelie" = "indianred", 
                               "Chinstrap" =
                                 "pink", 
                               "Gentoo" = "#4BA4A4")) +
  labs(x = "Flipper length (mm)", y = "Frequency", fill = "Penguin species") +
  myCustomTheme()